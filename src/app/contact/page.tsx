	...
	return (
		<ScrollablePage>
			<div className={styles.page}>
				<a href="/" className={styles.backLink}>← Back to 3D Portfolio</a>

				<header>
					<h1>Contact</h1>
					<p className={styles.role}>{resume.about.name} · {resume.contact.location}</p>
					{resume.contact.available && <span className={styles.badge}>Open to opportunities</span>}
				</header>
					...
					<address>
						<dl className={styles.dlList}>
							...
							<div className={styles.dlRow}>
								<dt>GitHub</dt>
								<dd>
									<a href={`https://${resume.contact.github}`} rel="noopener noreferrer">
							...
							<div className={styles.dlRow}>
								<dt>LinkedIn</dt>
								<dd>
									<a href={`https://${resume.contact.linkedin}`} rel="noopener noreferrer">
